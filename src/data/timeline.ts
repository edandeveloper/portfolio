...
export const timelineEvents: TimelineEvent[] = [
  ...
  },
  {
    ...
    label: 'LEVELLING ARC',
    title: 'Middle School',
    description: 'Stats began to grow. Discovered photography, first guitar chords, and a love of narrative. The character build starts to take shape.',
    icon: '📚',
    phase: 'growth',
  },
  {
  ...
  },
  {
    ...
    label: 'MAJOR QUEST',
    title: 'University',
    description: 'Enrolled in the grand quest. Studying technology at university. Party members gained, world expanded. The build becomes intentional.',
    icon: '🎓',
    phase: 'ascent',
  },
  {
