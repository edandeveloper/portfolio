...
export const inventoryItems: InventoryItem[] = [
  ...
  { id: 'pokemon',   icon: '🃏', name: 'Pokémon Card',       quantity: '999',    description: 'My favourite collectables, I mean, investments. These suckers will get me enough cash to buy a car, house, and then have extra left over to invest into even more pokemon cards.', type: 'item', rarity: 'rare' },
